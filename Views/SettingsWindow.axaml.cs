...
public partial class SettingsWindow : Window
{
    ...
    private void InitSettings()
    {
        ...
        {
            updateConfig.IsChecked = Settings.AutoUpdateConfig;
        }

        var noDeviceMode = this.FindControl<CheckBox>("NoDeviceModeBox");
        if (noDeviceMode != null)
        {
            noDeviceMode.IsChecked = Settings.NodeviceMode;
        }
        ...
        {
            bandwidthLimit.Text = Settings.BandwidthLimit.ToString();
        }
    }
    ...
    private static void CheckForUpdatesCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
    {
    ...
    private static void UpdateConfigCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
    {
        if (sender is CheckBox checkBox)
        {
    ...
    private static void DeleteAfterInstallCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
    {
        if (sender is CheckBox checkBox)
        {
    ...
    private static void TrailersOnCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
    {
        if (sender is CheckBox checkBox)
        {
    ...
    private static void SingleThreadCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
    {
        if (sender is CheckBox checkBox)
        {
    ...
    private static void UseDownloadedFilesCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
    {
        if (sender is CheckBox checkBox)
        {
    ...
    private static void AutoReinstallCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
    {
        if (sender is CheckBox checkBox)
        {
    ...
    private static void EnableMessageBoxesCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
    {
        if (sender is CheckBox checkBox)
        {
    ...
    private static void UserJsonOnGameInstallCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
    {
        if (sender is CheckBox checkBox)
        {
    ...
    private static void BMBFCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
    {
        if (sender is CheckBox checkBox)
        {
    ...
    private static void VirtualFilesystemCompatibilityCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
    {
        if (sender is CheckBox checkBox)
        {
    ...
    private static void HideAdultContentCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
    {
        if (sender is CheckBox checkBox)
        {
    ...
    private static void BandwidthLimitTextBox_KeyDown(object sender, KeyEventArgs e)
    {
        ...
        if (sender is TextBox textBox)
        {
            ...
            {
                // Allow control keys
                case Key.Back or Key.Delete or Key.Left or Key.Right or Key.Tab:
                // Allow digits
    ...
    private void ApplySettingsButton_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            if (bandwidthLimit != null)
            {
                var input = bandwidthLimit.Text ?? "0";
                var regex = new Regex(@"^\d+(\.\d+)?$");

                if (regex.IsMatch(input) && int.TryParse(input, out var limit))
                {
    ...
    private static void OpenDebugLogButton_Click(object sender, RoutedEventArgs e)
    {
        try
        {
    ...
    private static void ResetDebugLogButton_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            var debugLogPath = Settings.CurrentLogPath;
    ...
    private static async void UploadDebugLogButton_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            var debugLogPath = Settings.CurrentLogPath;
    ...
    private static void OpenDownloadDirectoryButton_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            var pathToOpen = Settings.CustomDownloadDir ? Settings.DownloadDir : AppDomain.CurrentDomain.BaseDirectory;
    ...
    private static void OpenBackupDirectoryButton_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            var pathToOpen = Settings.CustomBackupDir
                ? Settings.BackupDir
